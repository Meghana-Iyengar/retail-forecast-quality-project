...
demand forecast reliability, using the Rossmann Store Sales dataset (1,115 stores, ~1M records, 2013-2015) (Kaggle).

## Problem
Store-level sales forecasts drive inventory and staffing decisions, but naive 
forecasting approaches don't account for data quality issues like closed-store days, 
active promotions, and holidays which leads to inconsistent accuracy across stores.
...
## Tech used
Tableau Public, Miro, Notion, Python (pandas), Google Colab
